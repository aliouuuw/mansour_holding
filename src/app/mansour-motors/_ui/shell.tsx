...
function Header() {
  ...
  return (
    <header className="header" ref={ref}>
      <div className="wrap">
        <Link className="logo" to="/mansour-motors" aria-label="Mansour Motors, accueil">
          <img className="logo-mark logo-mark--on-light" src="/mansour-motors/logo-header.png" alt="" width={469} height={429} decoding="async" />
          <img className="logo-mark logo-mark--on-dark" src="/mansour-motors/logo-header-white.png" alt="" width={469} height={429} decoding="async" />
          <span className="logo-text">Mansour Motors</span>
        </Link>
        <nav id="site-nav" className={menu ? 'nav is-open' : 'nav'} aria-label="Principal">
          ...
          {menu ? (
            <div className="nav-sheet-foot">
              ...
              <a className="nav-sheet-wa" href={waLink('Bonjour Mansour Motors, je souhaite des informations.')} target="_blank" rel="noopener noreferrer">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d={WA_PATH} /></svg>
                WhatsApp
              </a>
              <a className="nav-sheet-ig" href={CONTACT.instagram} target="_blank" rel="noopener noreferrer">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d={IG_PATH} /></svg>
                Instagram
              </a>
        ...
        <div className="header-end">
          <OpenNote />
          <a className="header-call" href={CONTACT.tel}>
    ...
    <footer className="sign ch-dark" ref={innerRef}>
      <div className="wrap sign-grid">
        ...
        <div className="sign-col">
          ...
          <a className="sign-line" href={waLink('Bonjour Mansour Motors, je souhaite des informations.')} target="_blank" rel="noopener noreferrer">WhatsApp</a>
          <a className="sign-line" href={CONTACT.instagram} target="_blank" rel="noopener noreferrer">Instagram</a>
        </div>
