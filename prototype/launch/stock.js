...
const table = mountTurntable($('[data-turntable]'), {
  drive: 'pointer',
  modes: ['atelier', 'list', 'grid'],
})
const startVue = VUES[params.get('vue')] || (reduceMotion.matches ? 'list' : 'atelier')
table.setMode(startVue)
