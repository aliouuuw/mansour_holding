...
export function MansourMotorsLanding() {
  ...
  return (
    <div ref={containerRef} className="relative bg-surface-dim page-grain">
          ...
          <div className="max-w-5xl">
            ...
            >
              <Link
                ...
                className="group relative inline-flex items-center justify-center gap-3 overflow-hidden bg-rosso-600 px-8 py-4 text-[13px] font-black uppercase tracking-[0.2em] text-white transition-all hover:bg-rosso-500 hover:shadow-lg hover:shadow-rosso-600/30"
              >
              ...
              <a
                href="#contact"
                className="group inline-flex items-center justify-center gap-3 border border-white/20 bg-white/5 px-8 py-4 text-[13px] font-bold uppercase tracking-[0.2em] text-white backdrop-blur-sm transition-all hover:border-rosso-500 hover:bg-rosso-600/10 hover:text-rosso-400"
              >
                Nous Contacter
              </a>
            </motion.div>
      ...
      {/* Services Section */}
      <section id="services" className="relative bg-carbon-900 px-6 py-24 lg:px-12 lg:py-32 overflow-hidden text-white">
        <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-rosso-900/10 rounded-full blur-[150px] pointer-events-none -translate-y-1/2 translate-x-1/3" />
        ...
        <div className="relative mx-auto max-w-7xl z-10">
          <div className="mb-20 text-center flex flex-col items-center">
            ...
            >
              <span className="h-px w-12 bg-rosso-600" />
              <span className="block text-[11px] font-black uppercase tracking-[0.25em] text-rosso-500">
                Ce que nous offrons
              </span>
              <span className="h-px w-12 bg-rosso-600" />
            </motion.div>
            <motion.h2
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8, delay: 0.1, ease: [0.16, 1, 0.3, 1] }}
              className="max-w-2xl font-motors-display font-bold text-4xl text-white md:text-5xl lg:text-6xl"
            >
              NOS <span className="text-transparent bg-clip-text bg-gradient-to-r from-rosso-500 to-rosso-700 not-italic font-sans font-black uppercase text-[0.7em] tracking-tighter">SERVICES EXCLUSIFS</span>
            </motion.h2>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 relative">
            {services.map((service, index) => (
              <motion.div
                ...
                viewport={{ once: true, margin: "-50px" }}
                transition={{ delay: index * 0.1, duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
                className="group relative bg-carbon-950 p-10 transition-all duration-500 hover:bg-carbon-800 hover:shadow-rosso-sm lg:p-14 hover:-translate-y-2 rounded-sm border border-white/5 hover:border-rosso-600/50 overflow-hidden"
              >
                <div className="absolute -right-10 -top-10 h-40 w-40 rounded-full bg-rosso-600/10 blur-[30px] transition-all duration-500 group-hover:bg-rosso-600/20 group-hover:scale-150" />
                
                <div className="mb-10 flex items-start justify-between relative z-10">
                  <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-white/5 text-rosso-500 transition-all duration-500 group-hover:bg-rosso-600/20 group-hover:text-rosso-400 group-hover:-rotate-6 group-hover:scale-110">
                    <service.icon className="h-8 w-8" />
                  </div>
                  <span className="font-motors-display font-bold text-2xl text-white/20 transition-colors duration-500 group-hover:text-rosso-500/50">
                    {service.stat}
                  </span>
                </div>
                <div className="relative z-10">
                  <h3 className="mb-4 text-2xl font-black text-white transition-colors duration-500 group-hover:text-rosso-100">
                    {service.title}
                  </h3>
                  <p className="text-base leading-relaxed text-silver-400 transition-colors duration-500 group-hover:text-white/90">
                    {service.description}
                  </p>
                </div>
                <div className="mt-8 h-1 w-12 bg-white/10 transition-all duration-700 ease-out group-hover:w-full group-hover:bg-rosso-600 rounded-full" />
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section id="contact" className="relative bg-carbon-950 px-6 py-24 lg:px-12 lg:py-32 overflow-hidden text-white">
        ...
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-rosso-900/20 rounded-full blur-[120px] pointer-events-none -translate-y-1/2 translate-x-1/4" />
          ...
          <div className="grid gap-16 lg:grid-cols-2 items-center">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                <span className="h-px w-8 bg-rosso-600" />
                <span className="block text-[11px] font-black uppercase tracking-[0.25em] text-rosso-500">
                  Rendez-nous visite
                </span>
              </div>
              <h2 className="mb-8 font-motors-display font-bold text-4xl text-white md:text-5xl lg:text-6xl">
                NOTRE <span className="text-transparent bg-clip-text bg-gradient-to-r from-rosso-500 to-rosso-700 not-italic font-sans font-black uppercase text-[0.7em] tracking-tighter">SHOWROOM</span>
              </h2>
              <p className="mb-12 text-lg font-light leading-relaxed text-silver-300">
              ...
              <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
                {[
                  ...
                  >
                    <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-white/5 text-rosso-500 transition-all duration-500 group-hover:bg-rosso-600 group-hover:text-white group-hover:scale-110 border border-white/10 group-hover:border-rosso-600">
                      <item.icon className="h-5 w-5" />
                    </div>
                    <div>
                      <h4 className="mb-1.5 text-[11px] font-black uppercase tracking-[0.2em] text-silver-500 transition-colors group-hover:text-rosso-400">{item.title}</h4>
                      {item.href ? (
                        <a href={item.href} className="text-sm font-medium text-white transition-colors hover:text-rosso-400 whitespace-pre-line block">{item.content}</a>
                      ) : (
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 1, delay: 0.2, ease: [0.16, 1, 0.3, 1] }}
              className="relative overflow-hidden rounded-sm shadow-rosso-sm group"
            >
              ...
              <div className="aspect-[4/5] md:aspect-[4/3] overflow-hidden">
                ...
                <div className="absolute bottom-8 left-8 right-8 z-20 translate-y-4 opacity-0 transition-all duration-700 ease-out group-hover:translate-y-0 group-hover:opacity-100">
                  <div className="inline-flex items-center gap-3 backdrop-blur-md bg-white/10 border border-white/20 px-6 py-3 rounded-full">
                    <div className="h-2 w-2 rounded-full bg-rosso-500 animate-pulse" />
